		...
		return (
			<Router className="maindashboard">
				<div className="storedashboar_style">
					<button className="addnew-btn"><Link to={'/customerform'} className="nav-link"> Add New
						Customer </Link></button>
					<button className="customerrecord-btn"><Link to={'/customerList'} className="nav-link"> View All
						Customer</Link></button>
